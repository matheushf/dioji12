...
//            console.log(area);
    ...
    <div class="col-sm-8">
        ...
        <div class="propostas text-justify">
            ...
            <div class="proposta-item" data-item="1"><h3>Educação</h3>
                <ul>
                    <li>
            ...
            <div class="proposta-item" data-item="2"><h3><strong>Segurança</strong></h3>
                <ul>
                    ...
                    <li>
                        ...
                        áreas
                        propostas nesta primeira etapa.
                    </li>
                    <li>
                        Ampliar o Projeto Comércio Seguro: uma parceria com as polícias civil e militar, que dividiu a
                        cidade
                        em
                        regiões, com viaturas conectadas com a população por celular e grupos de Whatsapp.
                    </li>
                </ul>
            </div>

            <div class="proposta-item" data-item="3"><h3>Infra-estrutura</h3>
                <ul>
                    <li>
                        Recuperação da malha viária de toda cidade, por meio de recapeamento asfáltico de qualidade, com
                        a
                        devida
                        sinalização das ruas e avenidas.
                    </li>
                    <li>
                        Manutenção das ações de troca de luminárias e lâmpadas já existentes por sistemas mais modernos
                        em
                        todos
                        os
                        bairros.
                    ...
                    <li>
                        Concluir a implantação das obras da rede de esgoto em todos os bairros. Com isso Inhumas passará
                        a
                        ter
                        100% de
                        esgoto tratado.
                    ...
                    <li>
                        Promover a extensão da Avenida Bernardo Sayão até a GO-070, contribuindo para uma melhor
                        organização
                        do
                        trânsito.
                    </li>
                    <li>
                        Construção da Nova Etapa do Parques Goiabeiras, ao longo do córrego Goiabeiras, preservando um
                        importante
                        afluente do Rio Meio Ponte e embelezando ainda mais nossa Inhumas.
                    </li>
                </ul>
            </div>
            <div class="proposta-item" data-item="4"><h3>Social</h3>
                <ul>
                    <li>
                        Ampliar os atendimentos no Centro de Referência Especializado em Assistência Social (CREAS), no
                        Centro
                        de
                        Convivência do Idoso (CCI) e do Serviço de Convivência e Fortalecimento de Vínculos (SCFV),
                        antigo
                        PETI,
                        mantendo dignidade às famílias inhumenses.
                    </li>
                    <li>
                        Construção de novas unidades habitacionais, a exemplo dos 288 apartamentos do Residencial Sônia
                        Seabra
                        neste
                        ano de 2016.
                    </li>
                    <li>
                        Ampliar a oferta de cursos de capacitação, como panificação, artesanato, cuidado de idosos, e as
                        parcerias
                        com
                        as instituições filantrópicas da nossa cidade.
                    </li>
                    <li>
                        Criar cursos técnicos para atender às empresas que irão se instalar no Distrito Industrial
                        Athayde
                        Peixoto
                        de
                        Freitas.
                    ...
                    <li>
                        Criação da tarifa social de água para as famílias de baixa renda.
                    </li>
                </ul>
            </div>

            <div class="proposta-item" data-item="5"><h3>Mulheres</h3>
                <ul>
                    <li>
                        Criação do Hospital da Mulher e da Criança, com todas as especialidades médicas, como pediatria,
                        ginecologia,
                    ...
                    <li>
                        Ampliação dos serviços oferecidos pelo CREAS como o apoio psicológico e jurídico às pessoas em
                        situação de
                        vulnerabilidade social.
                    </li>
                    <li>
                        Criar o Conselho Municipal de Direitos da Mulher e realizar campanhas educativas que as
                        conscientizem
                        dos
                        seus
                        direitos.
                    ...
                    <li>
                        Fortalecer ainda mais as campanhas de prevenção de saúde da mulher (HPV; Câncer de Mama; Câncer
                        do
                        Colo do
                        Útero) etc.
                    </li>
            ...
            <div class="proposta-item" data-item="6"><h3>Juventude</h3>
